...
<body>
    ...
    <div class="home-slider">
      <div class="swiper-wrapper">
        <div class="swiper-slide slide" style="
              background: url(images/image-slider.jpg),
                linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5))
                  no-repeat;
            ">
          <div class="content">
            <span>Notre salon vous offre une expérience unique</span>
            <h3>La beauté à la portée de tous</h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- home about secton starts -->

  <section class="home-about">
    <div class="image">
      <img src="images/img-a-propos.jpg" alt="image à propos" />

    </div>

    <div class="content">
      <h1>manucure et pédicure chez GlowByGaël</h1>
      <p>
        GlowByGaël, un espace à la déco chaleureuse et cosy vous invite pour un moment de détente et de beauté.
        Nous vous accueillons pour sublimer vos ongles et votre regard. Nos 5 ans d’expérience nous permettent de
        maitriser des techniques basées sur de réels protocoles afin de prendre soin de vous sans compromettre la
        qualité de vos ongles ou de vos cils. Nous utilisons les meilleurs produits car nous sommes soucieux de votre
        bien-être..
      </p>
    </div>
  </section>
  <a href="book.php" class="btn-home">réserver maintenant</a>


  <!-- home about secton ends -->
  ...
  <section class="footer">
    ...
    <div class="credit">
      conçu par <span>mr. alexandre tchami</span> | tous les droits sont
      réservés!
    </div>
  </section>
